...
grave_site_df = data.frame(row.names = c("date", "indigenous", "corporate", "student", "document"))
for (file in files) {
    ...
    grave_site_df <- rbind(grave_site_df, data.frame(date, indigenous, corporate, student, document))
    #print(indigenous)
    #print(corporate)
    #print(student)
    #print(document)
...
grave_site_df$dates <- mdy(grave_site_df$date)
